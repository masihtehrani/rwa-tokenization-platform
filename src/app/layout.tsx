...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "RWA Labs - پلتفرم تخصصی توکنایز دارایی‌های فیزیکی",
    description: "پلتفرم پیشرفته توکنایز دارایی‌های فیزیکی: املاک، طلا، زعفران، پسته، صکوک دیجیتال. مشاوره رایگان، قراردادهای هوشمند امن، پشتیبانی 24/7",
    type: "website",
    locale: "fa_IR",
    siteName: "RWA Labs",
