...
export const metadata: Metadata = {
  title: "RWA Labs - پلتفرم تخصصی توکنایز دارایی‌های واقعی | توکن املاک، طلا، زعفران، پسته",
  description: "پلتفرم پیشرفته توکنایز دارایی‌های واقعی: املاک، طلا، زعفران، پسته، صکوک دیجیتال. مشاوره رایگان، قراردادهای هوشمند امن، پشتیبانی 24/7، بازار ثانویه، کیف‌پول اختصاصی",
  ...
  openGraph: {
    ...
    description: "پلتفرم پیشرفته توکنایز دارایی‌های واقعی: املاک، طلا، زعفران، پسته، صکوک دیجیتال. مشاوره رایگان، قراردادهای هوشمند امن، پشتیبانی 24/7",
    type: "website",
    locale: "fa_IR",
    siteName: "RWA Labs",
