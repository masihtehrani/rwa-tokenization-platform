...
export const metadata: Metadata = {
  title: 'توکنایز محصولات کشاورزی: فرصت‌ها و چالش‌ها | RWA Labs',
  description: 'راهنمای کامل توکنایز محصولات کشاورزی و دامداری. نحوه توکنایز زعفران، پسته، برنج و گوسفند با فناوری بلاکچین',
  keywords: 'توکنایز کشاورزی,توکن زعفران,توکن پسته,توکن برنج,توکن گوسفند,کشاورزی دیجیتال',
  openGraph: {
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
              توکنایز محصولات کشاورزی: فرصت‌ها و چالش‌ها
            </h1>
